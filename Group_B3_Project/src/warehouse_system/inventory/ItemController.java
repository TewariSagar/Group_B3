...
/**
 * @author wangyang xu it is item control system, including checking item
 *         available, adding item, reduce item quantity.
 */
public class ItemController {
	...
	public void addItem(Item i) {
		...
		// if the quantity of the item lower then the minimum (set by
		// administrator), we should additem
	}
	...
	public boolean itemAvailable(Item i) {
		...
		// check whether the item and the quantity of the item can meet the
