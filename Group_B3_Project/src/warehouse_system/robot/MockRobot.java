...
public class MockRobot implements Robot, Tickable, Report{
	...
	/**
	 * @param ID given individual ID
	 * @param p The initial Point
	 * @param system The corresponding RobotScheduler
	 */
	...
	/* （非 Javadoc）
	 * @see warehouse_system.robot.Robot#getID()
	 */
	public String getID() {
		return ID;
	}
	...
	/* （非 Javadoc）
	 * @see warehouse_system.robot.Robot#getBatteryState()
	 */
	...
	/* 
	 * @see warehouse_system.robot.Robot#Activate(java.lang.Object, java.lang.Object)
	 */
	...
	/* （非 Javadoc）
	 * @see warehouse_system.Report#printEvent(java.lang.String)
	 */
	@Override
